...
```{r}
#sum of all consecutive numbers from 0 to 1000 
sum_consec <- sum(seq(0,1000))
#sum of only even numbers from 0 to 1000 
sum_even <- sum(seq(0,1000, by = 2))
...
survey.clean$invalid.answers= apply(is.na(survey.clean), 1, sum)}
